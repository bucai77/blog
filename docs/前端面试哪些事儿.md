...
> [《Https 是如何保证安全的？》](https://zhuanlan.zhihu.com/p/110216210)
...
> [《Taro 性能优化实践》](https://taro-docs.jd.com/taro/docs/next/optimized-practice/)
...
- 软件/系统：不同环境下小程序生命周期触发不一致
- 特征值：开启监听的顺序不一致、监听触发次数不一致
- 蓝牙信息：设备数据结构不一致
